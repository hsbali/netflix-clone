							...
							<div className="col-md-8 py-5">
								<h1>
									...
									{itemDetails.release_date
										? itemDetails.release_date.substring(
												0,
												4
										  )
										: itemDetails.first_air_date
										? itemDetails.first_air_date.substring(
												0,
												4
										  )
										: ''}
								...
								<h6>
									Averate Rating: {itemDetails.vote_average} |
									Total Votes: {itemDetails.vote_count}
								</h6>
